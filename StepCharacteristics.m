                ...
                for k = 1: meshnum
                    for l = 1: meshnum
                        ...
                        [psi0_ave, psix_l(i, k, l+1), psiy_b(i, k+1, l) ] =...
                            obj.stepcharacteristics(Ox(i), Oy(i),  psix_l(i, k,l), psiy_b(i, k, l), phi0(k,l));
                ...
                for k = 1: meshnum
                    ...
                    for l = 1: meshnum
                        ...
                        [psi0_ave, psix_l(i, m, l+1), psiy_t(i, m, l)]  = ...
                            obj.stepcharacteristics(Ox(i), Oy(i),  psix_l(i, m,l), psiy_t(i, m+1, l), phi0(m,l));
                ...
                for k = 1: meshnum
                    for l = 1: meshnum
                        ...
                        [psi0_ave, psix_r(i, k, n), psiy_b(i, k+1, n)] = ...
                            obj.stepcharacteristics(Ox(i), Oy(i), psix_r(i, k,n+1), psiy_b(i, k, n), phi0(k,n));
                ...
                for k = 1: meshnum
                    for l = 1: meshnum
                        ...
                        [psi0_ave, psix_r(i, m, n), psiy_t(i, m, n)] = ...
                            obj.stepcharacteristics(Ox(i), Oy(i), psix_r(i, m,n+1), psiy_t(i, m+1, n), phi0(m,n));
